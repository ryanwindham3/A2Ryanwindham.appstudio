...
const cacheName = 'A2Ryanwindham-2021-09-18 13:20:26.246369'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2Ryanwindham'.length) === 'A2Ryanwindham') {
